<?php /* application/views/contact/index.php */

echo '<main id="main" class="main contact',((empty($display_main1)&&empty($display_main2)&&empty($display_main3)) ? ' no_content' : ''),'" role="main">',
