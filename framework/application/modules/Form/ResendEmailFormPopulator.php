<?php /* application/modules/Form/ResendEmailFormPopulator.php */
...
/**
 * ResendEmailFormPopulator
 *
 * The ResendEmailFormPopulator Class is used populate ResendEmail forms.
 *
 */
class ResendEmailFormPopulator extends FormPopulator
{
	/*** data members ***/
	...
	/**
	 * populateResendEmailForm
	 *
	 * Populates a ResendEmail form with content from the login table in the Databse using the id passed via GET data.
	 *
	 * @param    $data                    An array of values to populate the form with.
	 * @access    public
	 */
	public function populateResendEmailForm($data=array())
	{
		try
		{
			# Get the User class.
	 ...
	 *
	 * If there are new form data values from POST data, they are set to the appropriate data
	 * member (ResendEmailFormPopulator or User).
	 *
	 * @access    private
	 */
