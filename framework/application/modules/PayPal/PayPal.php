 ...
 * Find out more about available variables at:
...
class PayPal
{
     ...
     *
     * @param string $action The url the PayPal button sends POST data to.
     */
     ...
     *
     * @param string $cmd The type of button - _xclick, _donations, _xclick-subscriptions, _oe-gift-certificate, _cart,
     *                    _s-xclick
     * @throws Exception
     */
     ...
     *
     * @param string $hosted_button_id The ID of the button hosted on PayPal.
     */
     ...
     *
     * @param string $cancel_return The url to return the user to if they cancel the order process.
     * @throws Exception
     */
     ...
     *
     * @param string $custom A custom value to be passed through PayPal.
     */
     ...
     *
     * @param string $return The url to return the user to once the PayPal transaction is completed.
     * @throws Exception
     */
     ...
     *
     * @param string $shopping_url The url to send the user to if there is a shopping cart and they click "continue
     *                             shopping".
     * @throws Exception
     */
     ...
     *
     * @param array $options                  A multidimensional array:
     ...
     *
     * @param string $type  The type of submit button, ie image or subit. Default is submit.
     * @param string $name  The name of the submit button. Default is submit.
     * @param string $value The value of the submit button. Default is "Buy Now!".
     * @param string $image If the type of submit button is image, the URL to the source. Default is NULL.
     * @param string $class A class for the submit button. Default is NULL.
     */
     ...
     *
     * @param string $test Default is empty.
     */
     ...
     *
     * @param string $email_message The message to send via email in case of an error.
     */
     ...
     *
     * @param int $item_number The ID of the item in the Database.
     */
     ...
     *
     * @param string $button_name    Optional.
     * @param string $method         Optional.
     * @param string $target         Optional.
     * @param boolean $options       Optional.
     * @param boolean $shopping_cart Optional.
     ...
     *
     * @param boolean $fixed_price Optional.
     * @param string $user_field   Optional.
    ...
    public function processPayPal($fixed_price = true, $user_field = null, $email = null)
    {
        ...
        if(($_SERVER['REQUEST_METHOD'] == 'POST') && !empty($_POST))
        {
            ...
            # NOTE: Pointless since we are catching the error above?
            /*
            if($checkQuery !== 0)
            {
    ...
    public function redirectToPayPal($redirect = false)
    {
        ...
        if(array_key_exists('_submit_check', $_REQUEST))
        {
            ...
            if(!isset($_REQUEST['hosted_button_id']))
            {
                ...
                {
                    # TODO: Does this block work since the data members don't exist?
     ...
     */
    # TODO: Not being used, nor will it work.
    /*
    ...
    */
     ...
     * Processes an order submitted via Shopping Cart.
     */
    # TODO: Not being used, nor will it work since addCartToDB() doesn't work
    /*
    ...
    */
    ...
    protected function makeLog($mail = true)
    {
        ...
        if($mail === true)
        {
            ...
            $doc->sendEmail($this->error_subject, $this->email_to, $message);
        }
        if($mail !== true)
        {
     ...
     * @param mixed $email              The email address(es) to send the transaction notification to.
     ...
     * @param string $date         The date to add to. If the passed date is in the past or empty, it is updated to the
     *                             current date before adding time.
     * @return false|string
     */
     ...
     * Sends an email regarding the order.
     *
     * @param string                          /array $email        The email address(es) to send the transaction
     *                                               notification to. May be a string"single_email_address" or and
