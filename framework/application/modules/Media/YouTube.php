...
class YouTube
{
	...
	public function startYouTubeService()
	{
		...
		require_once Utility::locateFile(MODULES.'Social'.DS.'Google'.DS.'Client.php');
		# Get the YouTube Service.
		require_once Utility::locateFile(MODULES.'Social'.DS.'Google'.DS.'Service'.DS.'YouTube.php');
