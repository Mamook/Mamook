...
# TRUE if you want this script to work on your Development machine and Staging, FALSE for Production.
if(!defined('RUN_ON_DEVELOPMENT')) define('RUN_ON_DEVELOPMENT', FALSE);
define('RUN_ON_STAGING', FALSE);
//define('RUN_ON_STAGING', ((RUN_ON_DEVELOPMENT===TRUE) ? TRUE : FALSE));
...
require_once MODULES.'Validator'.DS.'Validator.php';
