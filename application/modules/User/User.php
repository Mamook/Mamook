	...
	*/
	...
	public function deleteAccount($id=NULL)
	{
		...
		try
		{
			...
			require MODULES.'User'.DS.'Contributor.php';
			...
			# Get the Staff class.
			require MODULES.'User'.DS.'Staff.php';
		...
		/*
			...
			require MODULES.'Product'.DS.'Subscription.php';
		...
		*/
			...
			require MODULES.'Content'.DS.'Comment.php';
			...
			if(WP_INSTALLED===TRUE)
			{
				...
				require MODULES.'User'.DS.'WordPressUser.php';
	...
	public function displayProfile($id, $table='user')
	{
		...
		try
		{
			...
			if($table=='staff')
			{
				...
				{
					# Get the Staff class.
					require_once MODULES.'User'.DS.'Staff.php';
					# Instantiate a new Staff object.
					$$table=new Staff();
				}
	...
	public function getSubscriptions($user_id=NULL)
	{
		...
		# Get the Subscription class.
		require_once MODULES.'Product'.DS.'Subscription.php';
		# Instantiate a new Subscription object.
		$subscription=new Subscription();
