...
# The domain name of the development application. (doesn't end with a slash)
...
require MODULES.'Utility'.DS.'Utility.php';
...
if(!empty($audio_data['FileName']))
{
	if(isset($audio_data['InsertID']))
	{
		...
		if(empty($audio_data['ImageID']))
		{
			...
			require_once MODULES.'getID3'.DS.'getid3'.DS.'getid3.php';
