<?php /* application/views/secure/admin/ManageContent/institutions/index.php */

echo '<main id="main" class="main secure',((empty($display_main1)&&empty($display_main2)&&empty($display_main3)) ? ' no_content' : ''),'" role="main">',
