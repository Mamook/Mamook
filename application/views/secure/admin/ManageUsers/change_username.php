<?php /* applications/views/secure/admin/ManageUsers/change_username.php */

echo '<main id="main" class="main secure username',((empty($display_main1)&&empty($display_main2)&&empty($display_main3)) ? ' no_content' : ''),'" role="main">',
