<?php /* public/secure/admin/ManageContent/categories/index.php */
...
try
{
	...
	define('HERE_PATH', 'secure/admin/ManageContent/categories/index.php');
	/*
	** In settings we
	...
	# Get the CategoryFormProcessor Class.
	require_once MODULES.'Form'.DS.'CategoryFormProcessor.php';
	...
	require(TEMPLATES.'forms'.DS.'category_form.php');
